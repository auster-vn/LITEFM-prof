...
def load_data():
    movies_df = pd.read_csv(r'C:\Users\tranc\movie-rcm-system-LightFM\data\tmdb_5000_movies.csv')
    credits_df = pd.read_csv(r'C:\Users\tranc\movie-rcm-system-LightFM\data\tmdb_5000_credits.csv')
